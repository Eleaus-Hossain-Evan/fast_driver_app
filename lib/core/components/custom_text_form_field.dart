...
class CustomTextFormField extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final border = OutlineInputBorder(
      borderSide: BorderSide(
        color: initialBorderColor ?? AppColors.neutral300,
        width: 1,
      ),
    );
    ...
    final focusBorder = border.copyWith(
      borderSide: BorderSide(
        color: borderColor ?? inputTheme.focusedBorder!.borderSide.color,
    ...
    return TextFormField(
      ...
      style: levelStyle.copyWith(color: AppColors.neutral),
      textAlign: textAlign,
      ...
      decoration: InputDecoration(
        ...
        labelText: labelText,
        labelStyle: levelStyle.colorSet(AppColors.neutral),
  ...
  factory CustomTextFormField.date({
    ...
    suffixIcon:
        suffixIcon ??
        Icon(Icons.calendar_month, color: Colors.blueGrey.withOpacity(.6)),
    focusNode: focusNode,
    isObscure: isObscure,
    onChanged: onChanged,
    onFieldSubmitted: onFieldSubmitted,
